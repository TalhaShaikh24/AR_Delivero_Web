  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.</p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li><b>Application</b> refers to AR DELIVERO, the software program provided by the Company.</li>
          <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AR DELIVERO, REHMANI TECHNOLOGIES BUILDING, BY PASS ROAD HANDWARA KASHMIR-193221.</li>
          <li><b>Country</b> refers to: Jammu and Kashmir, India.</li>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li>By phone number: +911955295310</li>
          <li>By mail: REHMANI TECHNOLOGY BUILDING, BYPASS ROAD HANDWARA KASHMIR-193221</li>
        </ul>
      </main>
      <Footer />
    </>
